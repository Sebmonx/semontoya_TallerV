...
#define RCC_BASE_ADDR		(ABH1_BASE_ADDR + 0x3800u)
#define GPIOH_BASE_ADDR		(ABH1_BASE_ADDR + 0x1C00u)
#define GPIOE_BASE_ADDR		(ABH1_BASE_ADDR + 0x1000u)
#define GPIOD_BASE_ADDR		(ABH1_BASE_ADDR + 0x0C00u)
#define GPIOC_BASE_ADDR		(ABH1_BASE_ADDR + 0x0800u)
#define GPIOB_BASE_ADDR		(ABH1_BASE_ADDR + 0x0400u)
#define GPIOA_BASE_ADDR		(ABH1_BASE_ADDR + 0x0000u)
...
#define GPIO_OSPEED_PULLUP		1
#define GPIO_OSPEED_PULLDOWN	2
