...
void inicializacion_Led_Estado(void){
	...
	timerLed.ptrTIMx = TIM2;
	timerLed.TIMx_Config.TIMx_mode	= BTIMER_MODE_UP;
	timerLed.TIMx_Config.TIMx_speed = TIMER_16Mhz_100us;
	timerLed.TIMx_Config.TIMx_period = 2500; // 250 ms
...
void inicializacion_pines_USART2(void){
	...
	PinTX_U2_handler.pGPIOx = GPIOA;
	PinTX_U2_handler.GPIO_PinConfig.GPIO_PinNumber = PIN_2;
	PinTX_U2_handler.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_ALTFN;
	PinTX_U2_handler.GPIO_PinConfig.GPIO_PinAltFunMode = AF7;
	GPIO_Config(&PinTX_U2_handler);

	// Inicialización de PIN A3 con función alternativa de USART2
	PinRX_U2_handler.pGPIOx = GPIOA;
	PinRX_U2_handler.GPIO_PinConfig.GPIO_PinNumber = PIN_3;
	PinRX_U2_handler.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_ALTFN;
	PinRX_U2_handler.GPIO_PinConfig.GPIO_PinAltFunMode = AF7;
	GPIO_Config(&PinRX_U2_handler);
